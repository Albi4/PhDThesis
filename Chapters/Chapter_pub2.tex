...
\begin{flushleft}
	...
	{\Large\href{https://doi.org/10.1103/PhysRevResearch.5.033117}{Phys. Rev. Research  \textbf{5}, 033117 (2023)}\linebreak}
	...
	{\large \textbf{Author contribution:}}
		%I took a supporting role in the process of designing the experimental sequence, acquiring and analyzing the data described in this publication as well as I contributed to the writing of the manuscript.  
		I made substantial contributions to the planning and execution of 
		the experiments. I took a supporting role in the data analysis, and the preparation of the manuscript.\linebreak
	\noindent
...
The values of the Feshbach resonance parameters $\delta B^*, \delta\mu$ and $B_0$ obtained from the binding energy spectroscopy and the magnetic moment spectroscopy are reported in Table \ref{Table:FBParameter}. The two methods give consistent results. We also present combined values for the three parameters, which represent our best knowledge.
