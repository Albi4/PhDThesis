...
\begin{flushleft}
	...
	{\Large\href{https://doi.org/10.1103/PhysRevResearch.7.023259}{Phys. Rev. Research  \textbf{5}, 033117 (2023)}\linebreak}
	...
	I  made substantial contributions to planning the experiments and acquiring the data described in this publication as well as to the discussions and interpretations of the results. I took a supporting role in the data analysis and in writing the manuscript. I acted as the corresponding author. \linebreak
	\noindent
...
$^{6}$Li-$^{53}$Cr~\cite{Neri2020roa, Ciamei2022euc, Ciamei2022ddf, Finelli2024ula}, 
...
On resonance, only the locked oscillation ($\sim78$\,Hz) is observed. In the Dy signal (b), the off-resonant K mode excitation is too weak to be observed in the data, but the resonant crossover to the locked mode can be clearly seen.
...
The fast damping mode appears as a direct manifestation of the rapid reduction in the relative velocity of the two species caused by strong friction in the resonantly interacting regime. 
...
The dotted curve in Fig.~\ref{fig:overlap}(b) illustrates that the second-order expansion remains a good approximation up to displacements of about \SI{10}{\micro m}, which corresponds to the linear regime of the reactive force between the two clouds.
