...
Research possibilities with heteronuclear mixture encompass different directions...

%In recent years heteronuclear mixtures have been incredibly successful in the realization of ground state molecules, with the realization of \ac{mBEC} in NaCs \cite{Bigagli2024oob} and NaRb \cite{Shi2025bec}, and degenerate Fermi gases of diamagnetic ground state NaK molecules  \cite{Schindewolf2022eom} 

One of the most successful and popular in the last years has been the use of heteronuclear mixtures, mainly by combining two different alkali metals, as a step with which assemble chemically stable ground state molecules. 
...
However, this is not the application of heteronuclear mixtures we are interested in this thesis. Instead of employing the different species to form molecules with large permanent dipole moment, our objective is to study how the presence of mass imbalance can affect the pairing mechanism, which is at the cornerstone of the \ac{BCS} theory. While the \ac{BCS} theory successfully explained the microscopic behavior of \textit{conventional} superconductors, the discovery of high temperature superconductors \albi{maybe put a date here}, i.e.~materials for which the phase transition towards the superconducting state occurs at temperatures of the order several tens of kelvin or higher\albi{cite}. Exotic pairing methods, different from the Cooper pair formation, are considered as possible explanations for this so-called \textit{unconventional} superconductors.

Mass-balanced, homonuclear spin mixture of Fermi gases proved to be a formidable platform to better understand conventional superconductors, providing an highly controllable experimental platform where to test the theory. Feshbach resonances and   \ac{BEC}-\ac{BCS}
...
First pristine candiated was mixture of Li and K as the only two alkali with fermionic isotopes and with both species being very successful in the study of  
