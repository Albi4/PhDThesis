...
First experimental realizations of the Li-K Fermi-Fermi mixture happened starting from $2008$ in multiple experiments around the world 
\cite{Wille2008eau, Tiecke2009fri,  }%moar cit needed

While the Li-K mixture proved to be and extremely fruitful mixtures over the last two decades, especially in the study of impurity physics \cite{Kohstall2012mac, Cetina2016umb, Baroni2024mib}

The Feshbach resonances available in the Li-K mixture however proved to be excessively narrow and prone to two- and three-body losses, which hindered the study of superfluidity. This, together with different new atomic species with fermionic isotopes getting brought to quantum degeneracy over the last decades, pushed towards the study of other possible combination.


strontium, ytterbium, chromium, dysprosium and erbium.

In order to choose the suitable mixture the mass ratio between the two components has to be correctly chosen. If  


mass ration criterion cite all important Dima paper.\cite{Petrov2005dmi}

Moreover, alkali-earth like atoms present a  closed-shell in the valence energy levels. Atoms with a closed shell, like strontium and ytterbium, have been observed to not support broad Feshbach resonances, and thus are not attractive to our goal of studying a strongly interacting system. 

The large dipole moment of highly magnetic atoms like Er and Dy, crucial in the study the role of long range interaction in ultracold gases 
It is particularly attractive for an experiment working with fermionic isotopes as, opposite to what happens with non magnetic atoms, intraspecies interaction are never completely frozen even at very low temperatures and quantum degeneracy can be reached in a single spin state, thanks to universal dipolar scattering \cite{Lu2012qdd,Aikawa2014rfd}




The extremely dense interaction spectrum of dysprosium, which has been observed to be chaotic \cite{Maier2015eoc}, complicates the feasibility of predicting the possible interaction spectrum of the mixture. Moreover, in fermionic isotopes have a finite nuclear spin, which provides additional splitting to the electronic states compared to bosonic isotopes, making theoretical prediction of the interaction spectrum of the mixture too cumbersome. In the last few years, thanks an increasing interest in exotic mixture of alkali and lanthanides, some first theoretical results have started to become available, like for example the estimation of Van der Waals coefficients for Er or Dy mixed with alkali or alkali-earth \cite{Kopczyk2024vdw}.
