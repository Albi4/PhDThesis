...
Research possibilities with Heteronucleae mixture encompass diferent directions...
...
One of the most successful and popular in the last years has been the use of mixtures (mainly with alkai) as a step to the goal of assembling chemically stable ground stare molecules. Interest in the large long range dipole interaction thanks to the permanent electric dipole moment. This branch of research, pioneered by with the study of KRb at jila in the last few years has reached great success with the realization of degenerate Fermi gas of NaK molecules (check) first and then with the successful production of a mBEC with NaCs. Even more recently there has been a flourishing of proposal to study unusual ground state molecules for precision measuements. 
