...
Similarly, mass-imbalanced Fermi mixtures hold the potential to deepen our understanding of unconventional superconductors. Exotic pairing mechanisms, different from the standard Cooper pair formation, are considered to be possible explanations for these \graffito{Unconventional superconductivity often occurs for higher critical temperatures then for standard systems}\textit{high-temperature} superconductors \albi{cite}. Theoretical calculations predict that the difference in mass between the two components of a pair could allow ultracold gases to access exotic phases of matter analogous to those present in unconventional superconductors. These phases are also predicted for spin mixtures; however, the conditions required for their realization are not experimentally attainable in such systems, while for heteronuclear mixtures they are predicted to occur under more realistic conditions.


Moreover similar unconventional pairing mechanism are also considered being present in other strongly interacting fermionic systems, such as neutron stars and primordial matter, in particular in the quark-gluon plasma phase present at the early stage of the universe \albi{citation needed}. Strongly interacting fermionic system for which the characteristic interaction length diverges, are said to be in the unitary regime 
...
, but experimental realization of these pairing mechanisms in experiments with a high degree of control is still lacking. few possible candidates to explore, and even less explored
