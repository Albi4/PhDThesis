...
In recent years heteronuclear mixtures have been incredibly successful in the realisation of ground state molecules, with the realization of mBec in NaCs \cite{Bigagli2024oob} and NaRb \cite{Shi2025bec}, and degenerate Fermi gases of diamagnetic ground state NaK molecules  \cite{Schindewolf2022eom} 

However, this is not the application of heteronuclear mixtures we are interested in this thesis. Instead of employing the different species to form molecules with large permanent dipole moment, our objective is to study how the presence of mass imbalance can affect the pairing mechanism, which is at the cornerstone of the \ac{BCS} theory. While the \ac{BCS} theory successfully explained the microscopic behavior of \textit{conventional} superconductors, the discovery of high temperature superconductors \albi{maybe put a date here}, i.e.~materials for which the phase transition towards the superconducting state occurs at temperatures of the order several tens of kelvin or higher.\albi{cite}

Exotic pairing methods, different from the Cooper pair formation, are considered as possible explanations for this \textit{unconventional} superconductors. In particular the \ac{FFLO} theory proposes a pairing between the components which results in a non-zero momentum pair.


Mass-balanced, homonuclear spin mixture of Fermi gases proved to be a formidable platform to better understand conventional superconductors, providing an highly controllable experimental platform where to test the theory. Feshbach resonances and   Becbcs
