...
The objective of our experiment is to study how the presence of mass imbalance could affect the pairing mechanism in fermionic superfluids. While the \ac{BCS} theory successfully explains the microscopic behavior of superconductivity in so-called \graffito{Superconductors are also categorized according to the type of
phase transition they undergo}\textit{conventional} systems, superconductors with critical temperatures of several tens of kelvin or higher are not explained within the same framework. These \textit{unconventional} superconductors, observed for the first time in $1986$ \cite{Bednorz1986pht}, are of particular interest for numerous potential industrial applications and the open theoretical questions they pose.
...
In this thesis, we focus on characterizing the interspecies interactions in the Dy-K mixture, building on results obtained by the previous members of the group \cite{Ravensbergen2020PhD,Soave2022PhD,Kreyer2023Phd}, characterizing a particularly promising Feshbach resonance. Before presenting the results regarding this resonance and the related studies we undertook, in the \hyperref[Chpt:Feshbach]{following chapter}, we provide an overview of strongly interacting fermionic gases, relevant to both spin and heteronuclear mixtures, to establish the theoretical background needed for the topics treated in this work. In Chapter~\ref{Chpt:Outline}, once the foundational physical concepts are established, we outline the remainder of this thesis, by summarizing each subsequent chapter.
...
%and the following efforts were

%identifying suitable scattering resonances and finally approaching the study of the \ac{BEC}-\ac{BCS} crossover with mass imbalance. 
