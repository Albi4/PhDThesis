...
\begin{figure}[thb]
	...
	\caption{Scattering length near a Feshbach resonance for different values of the pole strength $A$. The yellow and red curves overlap because they have the same value of $A$. The blue curve shows the scattering length for the Dy-K resonance near \SI{7}{G}, using the parameters characterized in this thesis. \label{fig:ScatteringLengthDiffAINtro}}
\end{figure}
