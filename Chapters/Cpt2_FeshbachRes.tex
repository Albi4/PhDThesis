...
Magnetically tunable Feshbach resonances are one of the central tools of ultracold-atom experiments. They allow the interaction strength between two atoms to be controlled by changing an external magnetic field. Here, we briefly summarize the main concepts of Feshbach resonance, while for a detailed overview, we refer to Ref.~\cite{Chin2010fri}, which is the standard reference for the topic. 
