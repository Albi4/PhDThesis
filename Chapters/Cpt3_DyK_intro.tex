...
\begin{figure}[thb]
	\includegraphics[width=0.8\columnwidth]{gfx/Cpt4_fig/hydroexpansion200G}
...
While a conservative guess on the parameter of the \SI{217}{G} resonance predicts a rather large universal regime, suitable to study many-body phenomena, and lifetimes measured in the proximity of the resonance are sufficiently long, the work at this magnetic field proved to be challenging over the years and ultimately unsuccessful. In the first place, the \SI{217}{G} resonance is not well isolated, and presents numerous narrow features, which prevent accurate tuning of the scattering length and cause additional losses. Moreover, the ramp from the preparation field, at \SI{250}{mG}, to the target region proved to be particularly detrimental, causing strong heating in the mixture due to the many inter-species resonance crossed during the ramp.

Despite the valiant efforts of many PhD students, a second stage of evaporative cooling at a magnetic field higher than \SI{500}{mG} was never achieved. In order to better understand this (apparently fundamental) limitation, the interaction spectrum of dysprosium alone was studied in a range of \SI{1}G in Ref.~\cite{Soave2022lff}. In Fig.~\ref{Fig:Dy1GFeshbachScan}
