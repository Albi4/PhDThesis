...
The use and reliance on the magnetic field gradient revealed it self to be a double edge sword in our experiments. On one hand it has been an extremely useful tool to control the overlap between the two atomic clouds, not only in reducing it to reduce unwanted heating effects but also maximizing it for the association of Feshbach molecules

and the stern Gerlach purification of the molecular sample from the non-associated atoms.  different magnetic moments and different polarizability do the trick

\ref{SubSec:SGPurification}


With the discovery of light induced losses the gradient helped partially compensating gravity allowing to keep light intensity low, thus increasing the lifetime of the trapped molecular sample. At the same time tho the uniformity of the magnetic field made more difficult to study 
\ref{Sec:Antitrapping} \ref{Sec:Collisions} \ref{Sec:Lifetime}
