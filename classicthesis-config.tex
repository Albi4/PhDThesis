...
% ****************************************************************************************************
\newcommand{\myTitle}{Feshbach Resonances and Weakly Bound Molecules in a Mass-Imbalanced Fermi Mixture of $^{161}$D\lowercase{y} and $^{40}$K \xspace}
...
\newcommand{\Dy}{\uppercase{D}{\fontshape{n}\selectfont \lowercase{y}}}
\usepackage{geometry}
%\usepackage{breqn}
% ****************************************************************************************************
